...
@section('content')
                                            ...
                                            <div class="d-flex align-items-center justify-content-center">
                                                ...
                                                @role('super-admin|isp')
                                                    ...
                                                    <button type="button" class="border-0" data-bs-toggle="modal"
                                                        data-bs-target="#deleteModal{{ str_replace(' ', '-', $username_pppoe) }}" title="Hapus">
                                                        <span>
                                                            <i style="font-size: 20px;" class="ti ti-file-x text-secondary"></i>
                                                        </span>
                                                    </button>
                                                    ...
                                                    <button type="button" class="border-0" data-bs-toggle="modal"
                                                        data-bs-target="#deleteModal1{{ str_replace(' ', '-', $username_pppoe) }}" title="Hapus">
                                                        <span>
                                                            <i style="font-size: 20px;" class="ti ti-trash-x text-danger"></i>
                                                        </span>
                                                    </button>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function(event) {
                    ...
                    const usernamePaket = this.getAttribute('data-nm-pppoe');
                    const actionUrl = this.getAttribute('data-action-url');

                    document.getElementById('usernamePaket').textContent = usernamePaket;
    ...
    {{-- <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const deleteButtons1 = document.querySelectorAll('.btn-delete1');

            deleteButtons1.forEach(button => {
                button.addEventListener('click', function(event) {
                    event.preventDefault();
                    const usernamePaket1 = this.getAttribute('data-nm-pppoe');
                    const actionUrl1 = this.getAttribute('data-action-url');

                    document.getElementById('usernamePaket1').textContent = usernamePaket1;
                    document.getElementById('deleteForm1').action = actionUrl1;
