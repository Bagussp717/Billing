...
@section('content')
    <div class="p-2">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    <td>{{ $invoice->pelanggan->profile_pppoe }} <br>
                        Periode : {{ \Carbon\Carbon::parse($invoice->tgl_invoice)->locale('id')->translatedFormat('d F Y') }} - {{ \Carbon\Carbon::parse($invoice->tgl_akhir)->locale('id')->translatedFormat('d F Y') }}
